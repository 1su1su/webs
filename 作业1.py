...
page = st.sidebar.radio('我的首页', ['我的推荐', '我的工具', '我的字典', '我的留言区'])
...
def page_1():
    ...
    st.write('音乐')
    st.write('中文：鸳鸯戏')
    # with open(r"C:\Users\Public\TurtleWorkspace\新的作品-2-副本-1\鸳鸯戏(吉他版)-略略略.320.mp3", 'rb') as f:
    #     mymp3 = f.read()
    # st.audio(mymp3, format='audio/mp3', start_time=0)
    st.write('英文：everyday')
    # with open(r"C:\Users\Lenovo\Desktop\刘松赫的网络根据地\Every Second-Mina Okabe.128.mp3", 'rb') as f:
    #     mymp3 = f.read()
    st.audio(mymp3, format='audio/mp3', start_time=0)
    st.write('日文：最初的梦')
    with open(r"C:\Users\Lenovo\Desktop\刘松赫的网络根据地\2462683254.mp3", 'rb') as f:
        mymp3 = f.read()
    st.audio(mymp3, format='audio/mp3', start_time=0)
